...
install:
	pip install --upgrade -e .[aws,bigquery,ckan,csv,dev,excel,json,github,gsheets,html,markdown,mysql,ods,pandas,parquet,postgresql,pyarrow,server,spss,sql,visidata,wkt,zenodo]
